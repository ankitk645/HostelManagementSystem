...
<div class="wrapper-search">
	...
	<div class="clear">	</div>
	<div class="form">
		<form action="updating.jsp" method="GET">
			<center> Update Student Details </center><br>
			<input class="searchbox" type="text" name="reg_num" placeholder="Registration Number" required><br>
			<input class="searchbox" type="text" name="till" placeholder="Fees Paid till" required><br>
			<input class="searchbox" type="text" name="roomno" placeholder="Room Number" required><br>
